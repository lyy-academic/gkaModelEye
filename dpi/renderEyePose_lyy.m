function [figHandle, plotObjectHandles, renderedFrame] = renderEyePose_lyy(eyePose, sceneGeometry, varargin)
...
p.addParameter('modelEyeLabelNames', {'aziRotationCenter' 'eleRotationCenter', 'retina' 'irisPerimeter' 'stopCenter' 'pupilPerimeter' 'pupilEllipse' 'cornea' 'cornealApex' 'glint_01' 'glint_02','glint_4th_01','glint_4th_02'}, @iscell);
p.addParameter('modelEyePlotColors', {'>r' '^m' '.w' 'ob' '+r' '*g' '-g' '.y' '*y' 'xr' 'xr','xb','xb'}, @iscell);
...
[pupilEllipseParams, ~, imagePoints, ~, ~, ~, pointLabels] = ...
    projectModelEye_lyy(eyePose, sceneGeometry, ...
